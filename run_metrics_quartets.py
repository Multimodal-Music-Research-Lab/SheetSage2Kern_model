...
from my_utils.metrics_original import compute_metrics, create_kern_file
...
def _write_sample_kerns(output_dir, sample_name, y_true, y_pred):
...
def run_metrics(
    ...
    wandb_logger = WandbLogger(
        project=PROJECT_NAME + "_quartets_metrics_original_code",
    ...
    for idx, batch in enumerate(iterator):
        ...
        if output_dir:
            ...
            if save_ground_truth:
                ...
                pred_dir.mkdir(parents=True, exist_ok=True)
                create_kern_file(pred_dir / f"{sample_name}.krn", yhat, 2)
